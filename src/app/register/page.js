...
import { User, Mail, Lock, ArrowRight, AlertCircle, Sparkles, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="glass-input w-full pl-10 pr-11 py-2.5 rounded-xl text-sm placeholder-slate-500 focus:border-emerald-500 transition-colors"
              />
              <button
                type="button"
                onClick={() => setShowPassword((v) => !v)}
                className="absolute right-3.5 top-3 text-slate-500 hover:text-emerald-400 transition-colors focus:outline-none"
                tabIndex={-1}
